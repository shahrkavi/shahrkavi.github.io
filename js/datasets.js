...
const DatasetsModule = (() => {
    ...
    const DATASETS = [
        ...
        { id: 'MOD_LST', name: 'MODIS Land Surface Temperature', info: '2000-اکنون | ۱ کیلومتر | روزانه', category: 'MODIS' },
        { id: 'MOD_VI', name: 'MODIS Vegetation Indices', info: '2000-اکنون | ۲۵۰ متر | ۱۶ روزه', category: 'MODIS' },
        { id: 'MOD_SNOW', name: 'MODIS Snow Cover', info: '2000-اکنون | ۵۰۰ متر | روزانه', category: 'MODIS' },
        { id: 'MOD_LAI', name: 'MODIS Leaf Area Index / FPAR', info: '2002-اکنون | ۵۰۰ متر | ۸ روزه', category: 'MODIS' },
    ...
    const BANDS_BY_SATELLITE = {
        ...
        'MOD_LST': ['lst_day', 'lst_night', 'emis_31', 'emis_32'],
        'MOD_VI': ['ndvi', 'evi', 'red_ref', 'nir_ref', 'blue_ref', 'mir_ref'],
        'MOD_SNOW': ['ndsi_snow_cover', 'snow_albedo', 'ndsi'],
        'MOD_LAI': ['lai', 'fpar'],
        'DEM': ['dem'],
        'GEH': [],
        'ESRI_WB': [],
    ...
    const BAND_LABELS = {
        ...
        'lst_day': 'دما روز (LST Day)',
        'lst_night': 'دما شب (LST Night)',
        'emis_31': 'امیتنس باند 31',
        'emis_32': 'امیتنس باند 32',
        'ndvi': 'شاخص پوشش گیاهی (NDVI)',
        'evi': 'شاخص پوشش گیاهی بهبودیافته (EVI)',
        'red_ref': 'بازتاب قرمز (Red Reflectance)',
        'nir_ref': 'بازتاب مادون قرمز (NIR Reflectance)',
        'blue_ref': 'بازتاب آبی (Blue Reflectance)',
        'mir_ref': 'بازتاب مادون قرمز میانی (MIR Reflectance)',
        'ndsi_snow_cover': 'پوشش برف (NDSI Snow Cover)',
        'snow_albedo': ' albido برف (Snow Albedo)',
        'ndsi': 'شاخص برف (NDSI)',
        'lai': 'شاخص سطح برگ (LAI)',
        'fpar': 'کسر تابش فتوسنتزی (FPAR)',
    };
